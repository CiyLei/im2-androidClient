 ...
 * Describe: 已读会话消息任务
 */
internal class ReadConversationTask(private val mConversationKey: String) : ITask.Stub() {

    override fun onCmdId(): Int = Constant.CMD.READ_CONVERSATION

    override fun onReq2Buf(): ByteArray =
        PrReadConversation.ReadConversationRequest.newBuilder().setConversationKey(mConversationKey)
            .build().toByteArray()
